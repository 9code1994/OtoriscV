...
#[cfg(target_arch = "wasm32")]
pub fn can_compile_block(block: &crate::cpu::rv32::jit::v2::BasicBlock) -> bool {
    use rv_opcode::*;
    ...
    // Also check terminator - only fallthrough is safe
    matches!(&block.ty, crate::cpu::rv32::jit::v2::BasicBlockType::Fallthrough { .. })
}
